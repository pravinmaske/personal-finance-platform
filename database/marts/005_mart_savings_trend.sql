...
SELECT
    ...
    -- True wealth building rate: committed savings as % of income
    -- (savings_transfers + india + investments) / income
    -- Does NOT add pipeline_net_flow to avoid double-counting
    ROUND(
        (
            ABS(COALESCE(SUM(amount) FILTER (
